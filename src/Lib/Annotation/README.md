...
class ActorDto {
     /**
      * @SwagDtoQuery(name="example", type="integer", required=true, minimum=10, maximum=100)
      */
    private $example;
```
...
### :bookmark: `@SwagRequestBodyContent`
