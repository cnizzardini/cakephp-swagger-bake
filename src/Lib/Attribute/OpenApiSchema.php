...
class OpenApiSchema
{
    ...
    /**
     * Always add the schema to default & vendor locations.
     */
    ...
    /**
     * Never add the schema anywhere (default or vendor location). Warning this can break request body definitions and
     * response samples.
     */
